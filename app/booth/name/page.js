...
// REMOVED static imports for @mediapipe here to fix build errors
...
export default function BoothNamePage() {
  ...
  useEffect(() => {
    ...
    async function setup() {
      // Dynamic loading bypasses the Turbopack/Next.js build module errors
      await loadScript('https://cdn.jsdelivr.net/npm/@mediapipe/hands/hands.js');
      await loadScript('https://cdn.jsdelivr.net/npm/@mediapipe/camera_utils/camera_utils.js');

      // Access from window object because they were loaded via script tags
